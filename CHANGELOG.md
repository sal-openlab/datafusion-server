...
* Updates latest crate dependencies
    * Updates to Apache DataFusion v52.3
        + https://github.com/apache/datafusion/blob/main/dev/changelog/52.3.0.md

## 0.20.12 (2026-03-04)

* Updates latest crate dependencies
    * Updates to Apache DataFusion v52.2
        + https://github.com/apache/datafusion/blob/main/dev/changelog/52.2.0.md
...
* Updates latest crate dependencies
    * Updates to Apache DataFusion v52 and Apache Arrow v57.1
        + https://github.com/apache/datafusion/blob/main/dev/changelog/52.0.0.md
        + https://github.com/apache/arrow-rs/blob/57.1.0/CHANGELOG.md
...
* Updates latest crate dependencies
    * Updates to Apache DataFusion v50.3
        + https://github.com/apache/datafusion/blob/main/dev/changelog/50.3.0.md
...
* Updates latest crate dependencies
    * Updates to Apache DataFusion v50.1
        + https://github.com/apache/datafusion/blob/main/dev/changelog/50.1.0.md
    * Updates other latest crates
